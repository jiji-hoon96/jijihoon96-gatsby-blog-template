---
emoji: 🔥
title: 'Zustand 불변성 관리와 immer 미드루에어 동작 원리(valtio를 곁들인)'
date: '2024-11-16'
...
zustand의 immer에 대해 알아보기전에 불변성에 대해 알아보자.
...
아래와같은 javascript 언어적 특성도 불변성 완전 보장에 문제를 야기한다.
...
이런 저런 수다를 나누었다. 2일뒤 zustand maintainer(Daishi Kato)가 왔다. immer로는 완전한 불변성 보장이 힘들기에 valtio를 만들었다한다.
